...
class RiskSubmissionFormValidationMixin:
    ...
    def _validate_driver_step(self, data):
        ...
        for phone, label, validator in (
            (data.get("driver_phone"), "celular del conductor", self._validate_mobile_phone),
            (data.get("driver_optional_phone"), "telefono opcional", self._validate_phone),
            (data.get("family_reference_phone"), "celular de referencia familiar", self._validate_mobile_phone),
            (data.get("cargo_reference_phone"), "celular de referencia de carga", self._validate_mobile_phone),
        ):
