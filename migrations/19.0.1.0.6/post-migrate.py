...
Ajusta las rutas no vehiculares para usar nombre y cedula del conductor.
"""
...
def migrate(cr, version):
    ...
    _logger.info(
        "risk_module 19.0.1.0.6 post-migrate: updating SharePoint route folder "
        "templates to driver name/document (previous version=%s).",
        version,
    )
    cr.execute(
        """
